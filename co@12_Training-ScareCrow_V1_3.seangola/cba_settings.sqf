...
force ace_advanced_fatigue_terrainGradientFactor = 1.2;
...
force VCM_AISKILL_AIMINGSPEED_E = 0.25;
force VCM_AISKILL_AIMINGSPEED_R = 0.25;
force VCM_AISKILL_AIMINGSPEED_W = 0.25;
